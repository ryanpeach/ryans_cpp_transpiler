from py_idiomatic_regex import Regex, ALPHA, ALPHA_NUMERIC

# A valid variable, type, class, or function name
NAME = Regex().literal(ALPHA) \
              .literal(
                  Regex().any_char('_', ALPHA_NUMERIC) \
                         .zero_or_more_repititions()
              )

# The left hand side of a variable declaration
LVALUE = (NAME + Regex().whitespace()) \
...
DECLARATION = (NAME + Regex().whitespace()) \
                     .m_or_more_repititions(2) \
                     .literal("=") \
                     .anything() \
                     .literal(";")